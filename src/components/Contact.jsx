...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Robin Kempen",
          from_email: form.email,
          to_email: "robinkempen1997@gmail.com",
  ...
  return (
    ...
    >
      ...
      >
        <p className={styles.sectionSubText}>{t("contact.headerSmall")}</p>
        <h3 className={styles.sectionHeadText}>{t("contact.headerBig")}.</h3>
